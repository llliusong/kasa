...
public class AssertUtils {
     ...
     *
     * @param object the object to check
     * @param r      the exception message to use if the assertion fails
     * @throws BusinessException if the object is {@code null}
     */
    public static void notNull(Object object, ResultCodeEnum r) {
        if (object == null) {
    ...
    /**
     * 比较两个数返回指定异常
     * 规则：当 num1 大于等于num2 抛出指定异常
     *
     * @param num1
     * @param num2
     */
    public static void compareNum(Integer num1, Integer num2, String msg) {
        if (num2 < num1) {
